...
Access control and security definitions in sale_order_country_allowed_product.
...
- **[res_groups.xml](../sale_order_country_allowed_product/security/res_groups.xml)**
