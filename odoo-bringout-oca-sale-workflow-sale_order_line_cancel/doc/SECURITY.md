...
Access control and security definitions in sale_order_line_cancel.
...
- **[sale_order_line_cancel.xml](../sale_order_line_cancel/security/sale_order_line_cancel.xml)**
