...
Access control and security definitions in stock_removal_location_by_priority.
...
- **[stock_security.xml](../stock_removal_location_by_priority/security/stock_security.xml)**
